...
class _fasterRCNN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic, lc, gc, da_use_contex, in_channel=4096):
        ...
        if self.da_use_contex:
            ...
            if self.gc:
                in_channel += 128
        print('Input Channel for RCNN Instance DA:', in_channel)
    ...
    def forward(
        ...
        # print (self.counter)
        # print("Input Image: ", im_data.shape)
        # print(im_data)
        # pdb.set_trace()
        if target:
        ...
        # print("base_feat1: ", base_feat1.shape)
        # print(base_feat1)
        if self.lc:
        ...
        # print('pooled_feat (before):', type(pooled_feat), pooled_feat.shape)
        # print(pooled_feat)
        pooled_feat = self._head_to_tail(pooled_feat)
        # print('pooled_feat (after):', type(pooled_feat), pooled_feat.shape)
        # print(pooled_feat)
        instance_pooled_feat = pooled_feat
        # print('instance_pooled_feat:', type(instance_pooled_feat), instance_pooled_feat.shape)
        # print(instance_pooled_feat)
        ...
        if self.lc:
            ...
            # print('instance_pooled_feat after lc:', instance_pooled_feat)
        if self.gc:
            ...
            # print('instance_pooled_feat after gc:', instance_pooled_feat)
            # compute bbox offset
        ...
        # remove nan value
        # instance_pooled_feat = torch.nan_to_num(instance_pooled_feat)
        # instance_pooled_feat[instance_pooled_feat != instance_pooled_feat] = 0.001
        # print('instance_pooled_feat: ', type(instance_pooled_feat), len(instance_pooled_feat))
        # print(instance_pooled_feat)
        ...
        # print (self.counter)
        # print ('instance_sigmoid: ', type(instance_sigmoid), len(instance_sigmoid))
        # print (instance_sigmoid)
        self.counter += 1
        # print ('same_size_label: ', type(same_size_label), len(same_size_label))
        # print (same_size_label)
