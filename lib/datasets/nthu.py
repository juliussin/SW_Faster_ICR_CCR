...
class nthu(imdb):
    def __init__(self, image_set, city, devkit_path=None):
        imdb.__init__(self, "nthu_" + city + "_" + image_set)
        ...
        self._data_path = os.path.join(self._devkit_path, self._city, "VOC2007")
        print("NTHU Data Path:", self._data_path)
        self._classes = (
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, "NTHU_dataset")
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, "results", self._city, "VOC" + self._year, "Main")
    ...
    def _do_python_eval(self, output_dir="output"):
        annopath = os.path.join(
            self._devkit_path, self._city, "VOC" + self._year, "Annotations", "{:s}.xml"
        )
        ...
        cachedir = os.path.join(self._devkit_path, self._city, "annotations_cache")
        aps = []
